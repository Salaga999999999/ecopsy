...
<main class="main" id="js-main">
    <div class="page">
        <header class="page__header _inline">
            <div class="page__header-content">
                ...
                <div class="page__header-text">
                    <p>Опираясь на свой многолетний практический опыт и академическое образование в области психологии, экономики и менеджмента, консультанты «ЭКОПСИ» изо дня в день решают масштабные бизнес&#8209;задачи и находят эффективные способы работы с персоналом в крупных организациях России, Украины, Казахстана и других стран</p>
                </div>
            </div>
        </header>

        <div class="filter-wrap _inline" id="js-filter">
            <form action="./ajax/filter.php" method="get" class="filter">
                        ...
                        <div class="filter__controls-container">
                            ...
                            <div class="filter__checkboxes">
                                <div class="filter__checkbox">
                                    <input id="filter-type-1" name="type[]" value="0" type="checkbox"><label for="filter-type-1">Описание
                                        подхода</label>
                                </div>
                                <div class="filter__checkbox">
                                    <input id="filter-type-2" name="type[]" value="1" type="checkbox"><label for="filter-type-2">Кейс</label>
                                </div>
                                <div class="filter__checkbox">
                                    <input id="filter-type-3" name="type[]" value="2" type="checkbox"><label for="filter-type-3">Обзорная
                                        статья</label>
                                </div>
                                <div class="filter__checkbox">
                                    <input id="filter-type-4" name="type[]" value="3" type="checkbox"><label for="filter-type-4">HRTimes</label>
                                </div>
                            </div>
                        </div>
                        <button class = "btn filter__reset" type="button">
                            Сбросить
                        </button>
                    </div>
                    ...
                    <div class="filter__row _selects">
                        <div class="filter__controls-container">
                            <select name="type[]" class="js-multiselect _fixed-visible" multiple placeholder="Тип инсайта">
                                <option value="Обучение и развитие людей">Описание
                                    подхода</option>
                                <option value="Оценка людей">Кейс</option>
                                <option value="Разработка HR-систем">Обзорная
                                    статья</option>
                                <option value="Работа с мнениями и отношениями людей">HRTimes</option>
                            </select>

                            <select name="format[]" class="js-multiselect" multiple placeholder="Формат">
                                <option value="Обучение и развитие людей">Обучение и развитие людей</option>
                                <option value="Оценка людей">Оценка людей</option>
                                <option value="Разработка HR-систем">Разработка HR-систем</option>
                                <option value="Работа с мнениями и отношениями людей">Работа с мнениями и отношениями людей</option>
                            </select>

                            <select name="theme[]" class="js-multiselect" multiple placeholder="Тема">
                                <option value="Обучение и развитие людей">Обучение и развитие людей</option>
                                <option value="Оценка людей">Оценка людей</option>
                                <option value="Разработка HR-систем">Разработка HR-систем</option>
                                <option value="Работа с мнениями и отношениями людей">Работа с мнениями и отношениями людей</option>
                            ...
                            <select name="author[]" class="js-multiselect js-filter-search" multiple placeholder="Автор">
                                ...
                                <option value="Разработка HR-систем">Разработка HR-систем</option>
                                <option value="Работа с мнениями и отношениями людей">Работа с мнениями и отношениями людей</option>
                                <option value="Амелина Анна">Амелина Анна</option>
                            </select>
                        </div>
                        <div class="filter__btns">
                            ...
                            <button class = "btn _default _primary filter__apply" type="button">
                                Применить
                            </button>
                        </div>
                    </div>
        ...
        <button type="button" class="btn _show js-show-filters" data-toggle-text="Скрыть фильтры">
            ...
            <svg class="_icon-show-btn"><use xlink:href="./i/sprite.svg#show-btn"></use></svg>
    ...
    <?php
        $articles = mysqli_query($connection, "SELECT * FROM `articles` LIMIT 6");
        ...
        ?>
            <a href="<?php if (isset($_SESSION["admin"]))
                {
                    echo "change_article.php?id=" . $article["id"];
                }
                else {echo "article.php?id=" . $article["id"];}
            ?>" class="card-article">
        <span class="card-article__wrap-img">
            <img src="<?php echo $article["img"];//нужно добавить альт в дб?>">
        </span>
        <span class="card-article__info">
            <span class="card-article__info-top">
                <?php $categories = mysqli_query($connection, "SELECT * FROM `categorie` WHERE `id` LIKE " . $article["categorie"]);
