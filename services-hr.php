...
<a href="services-learning-first.html" class="btn _transparent ">Обучение и развитие</a>
<a href="services-consulting.html" class="btn _transparent ">Оценка персонала</a>
<a href="services-assesment.html" class="btn _transparent ">Работа с топ-менеджерами</a>
<a href="services-learning-second.html" class="btn _transparent ">Системы управления персоналом</a>
<a href="services-opinions.html" class="btn _transparent ">Работа с мнениями и отношениями персонала</a>
<a href="services-systems.html" class="btn _transparent ">Системы управления организацией</a>
<a href="services-security.html" class="btn _transparent ">Промышленная безопасность</a>
<a href="services-success.html" class="btn _transparent ">SAP SuccessFactors </a>
...
<!--    если у .video__iframe-wrap не задан стиль background-image, превью видео подгрузится из youtube / vimeo-->
    <div class="video__iframe-wrap js-video-wrap" style="background-image: url(./i/c/about-video-bg.jpg)">
        ...
        <a href="#">
            <h4 class="card-solution__title">Система работы с талантами&nbsp;/&nbsp;Кадровый резерв</h4>
                        ...
                        <div class="container__show-more-cards">
                            <a href="/ajax/solutions.php?PAGEN_1=0" class="btn _default _primary js-show-more-cards">Показать еще</a>
                        </div>
                    </div>
                </div>
