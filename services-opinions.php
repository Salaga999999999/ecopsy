...
<?php include "includes/services_header.php";?>
                ...
                <div class="page__hero-content-wrap">
                    <div class="page__hero-content">
                        <div class="page__preview-text _lg">
                            <h2>Работа с&nbsp;мнениями и&nbsp;отношениями персонала</h2>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Корпоративная культура</h4>
        </a>
    </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Вовлеченность</h4>
        </a>
    </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Межфункциональное взаимодействие&nbsp;/ отношение к&nbsp;отдельным подразделениям</h4>
        </a>
    </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Бренд работодателя</h4>
        </a>
    </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Внутрикомандное взаимодействие</h4>
        </a>
    </div>
    <div class="cards">
