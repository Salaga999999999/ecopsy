...
<form action="addition_services_script.php" method="POST">
    <p style="color: black;">Название услуги</p>
        <div class="field ">
            <input type="text" name="RUS" required>
        </div><br>
        ...
        <select name="parant_id">
            ...
            <?php
            $services = mysqli_query($connection, "SELECT * FROM `menu__lists` WHERE `parant_id` = 0");
...
<input type="submit" name="button" value="Добавить услугу" /> </br>
</form>
