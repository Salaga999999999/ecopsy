...
?>
<form action="change_article_script.php" enctype="multipart/form-data" method="POST">
    <p style="color: black;">Заголовок</p>
        <div class="field ">
            <input type="text" name="title" value="<?php echo $article["title"]?>" required>
        </div>
        <p style="color: black;">Текст статьи</p>
        <div class="field  _textarea">
            <textarea type="text" name="text" required><?php echo $article["text"]?></textarea>
        </div>
        <p style="color: black;">Изображение</p>
<input type="file" name="path" title="Выберите файл"/> </br>
<input type="hidden" value="<?php echo$_GET["id"];?>" name="id"/>
</br>
<input type="submit"  name="button" value="Подтвердить изменение статьи" /> </br>
</form>



            </div><form action="delete_article_script.php" enctype="multipart/form-data" method="POST">
    <input type="hidden" value="<?php echo$_GET["id"];?>" name="id"/>
    <input type="submit"  name="button" value="Подтвердить удаление статьи" />
    </form>
