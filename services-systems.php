...
<?php include "includes/services_header.php";?>
                ...
                <div class="page__hero-content-wrap">
                    <div class="page__hero-content">
                        <div class="page__preview-text _lg">
                            <h2>Системы управления организацией</h2>
                        ...
                        <a href="#" class="page__read-more-btn btn _default _primary _lg js-popup-open" data-service-id="2" data-popup="#services">Узнать больше</a>
                    </div>
                </div>
            </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Проведение стратегических сессий</h4>
        </a>
    </div>

    <div class="card-solution">
         <span class="card-solution__wrap-img">
             <svg class="_icon-solution11"><use xlink:href="./i/sprite.svg#solution11"></use></svg>

         </span>
        <a href="#">
            <h4 class="card-solution__title">Организационная структура и бизнес-процессы</h4>
        </a>
    </div>

    <div class="card-solution">
         <span class="card-solution__wrap-img">
             <svg class="_icon-solution12"><use xlink:href="./i/sprite.svg#solution12"></use></svg>

         </span>
        <a href="#">
            <h4 class="card-solution__title">KPI</h4>
        </a>
    </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Повышение операционной эффективности</h4>
        </a>
    </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Практики регулярного менеджмента</h4>
        </a>
    </div>
    ...
    <div class="card-solution">
        ...
        <a href="#">
            <h4 class="card-solution__title">Производственная система</h4>
        </a>
    </div>
