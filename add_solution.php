...
<form action="addition_colution_script.php" method="POST">
    <p style="color: black;">Название предложения:</p>
        ...
        <select name="parant_id">
            ...
            {
            ?>
                <option value="<?php echo $service["id"];?>"><?php echo $service["RUS"];?></option>
...
<div><input type="submit" name="button" value="Добавить предложение" /></div> </br>
</form>
