    ...
    <main class="main" id="js-main">
        <div class="page">
            <header class="page__header">
                <strong class="page__title _visually-h1">Услуги</strong>
...
<?php include "includes/services_header.php";?>
            ...
            <div class="page__hero">
                <picture class="page__bg" id="js-page-bg">
                    <img src="./i/c/bg/services-1.jpg" alt="">
                </picture>

                <div class="page__hero-content-wrap">
                    <div class="page__hero-content">
                        <div class="page__preview-text _lg">
                            <h2 id="service-title">test2 3</h2>
                            <p>Тест разработан ЭКОПСИ&nbsp;Консалтинг&nbsp;&mdash; компанией &#8470; 1&nbsp;в российском HR&nbsp;-&nbsp;консалтинге</p>
                        </div>

                        <!--Блок .video также принимает data-vimeo-id-->
<div class="video js-video" data-youtube-id="20Ap1kH8wuU">
<!--    если у .video__iframe-wrap не задан стиль background-image, превью видео подгрузится из youtube / vimeo-->
    <div class="video__iframe-wrap js-video-wrap" style="background-image: url(./i/c/services-video-bg.jpg)">
        <button type="button" class="video__play js-video-play">
               <svg class="_icon-play"><use xlink:href="./i/sprite.svg#play"></use></svg>
            ...
            <div class="page__content">
                <div class="container _mobile-video">
                    <!--Блок .video также принимает data-vimeo-id-->
<div class="video js-video" data-youtube-id="20Ap1kH8wuU">
<!--    если у .video__iframe-wrap не задан стиль background-image, превью видео подгрузится из youtube / vimeo-->
    <div class="video__iframe-wrap js-video-wrap" style="background-image: url(./i/c/services-video-bg.jpg)">
        <button type="button" class="video__play js-video-play">
               <svg class="_icon-play"><use xlink:href="./i/sprite.svg#play"></use></svg>
                ...
                <div class="container">
                    ...
                    <a href="prez.pdf" class="btn _default _primary _service-prezentation">Скачать презентацию</a>
                </div>

                <div class="container _lg">
                    <div class="container__head">
                        <strong class="container__title _visually-h3">Предложения</strong>
                    </div>
    ...
    ?>
                ...
                <div class="container _lg">
                    <div class="container__head">
                        <strong class="container__title _visually-h3">Клиенты</strong>
                ...
                <div class="container _lg">
                    <div class="container__head">
                        <strong class="container__title _visually-h3">Команда</strong>
        ...
        <div class="card-team">
            ...
            <div class="card-team__info">
                ...
                <p>Партнер, руководитель направления &laquo;HR-маркетинг&raquo;</p>
            </div>
        </div>
        ...
        <div class="card-team">
            ...
            <div class="container _wrap-form" style="background-image: linear-gradient(248.95deg, #7998B4 0%, #17416E 100%);">
                ...
                <div class="container__head">
                    <strong class="container__title _visually-h3">Не смогли найти то, что искали?</strong>
...
<form action="./ajax/form.php" method="get" class="form js-form" data-form-name="default">
    ...
    <div class="form__hidden-inputs">
            ...
            <div class="page__content">
                <div class="container _lg">
                    <div class="container__head">
                        <strong class="container__title _visually-h3">Инсайты по теме</strong>
    ...
    >
        ...
        <span class="card-article__info">
            ...
            <h4>Switch &mdash; тесты способностей нового поколения</h4>
    ...
    >
        ...
        <span class="card-article__info">
            ...
            <h4>Меньше временных затрат &mdash; больше результат: как сократить трудоемкось работы с отчетностью. Методика TIME</h4>
            <p>Российские и зарубежные компании ценят в менеджерах совершенно разные качества</p>
        </span>
        <span class="card-article__bottom-line">
        ...
        <div class="footer__info-content">
            ...
            <div class="footer__info">
                ...
                <div class="footer__policy-copyright _desktop-only">
                    ...
                    <span class="footer__copyright">&copy; 2019 Экопси Консалтинг</span>
                </div>
            </div>
